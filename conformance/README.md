...
| `AKB007` | References resolve to declared IDs. | `invalid/unresolved-parent`, `invalid/unresolved-source-ref`, `invalid/unresolved-discovered-via`, `invalid/link-target-unresolved` |
